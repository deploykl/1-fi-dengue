<template>
    <div>
        ...
        <div class="d-flex flex-wrap justify-content-center align-items-center">
            <div v-for="header in headers" :key="header.key" class="p-2">
                <div class="filter-label text-center" v-if="isFilterActive(header.key)">
                    {{ header.label }}
                </div>
...
import ExportButtonsVue from './ExportButtons.vue';
