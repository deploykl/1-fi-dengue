<template>
    ...
    <aside v-if="!isControlPage" id="sidebar" class="sidebar d-flex flex-column">
        <ul class="sidebar-nav" id="sidebar-nav">
            <li class="nav-item">
                <router-link :to="{ name: 'poi-dashboard' }" class="nav-link collapsed">
            ...
            <li v-if="isStaff || (isSuperuser && !isStaff)" class="nav-item">
                <router-link :to="{ name: 'admin-grupo-vinculo' }" class="nav-link collapsed">
                    <i class="fa-sharp fa-solid fa-people-group"></i><span>Grupo Vinculo</span>
                </router-link>
            </li>
            <li v-if="isStaff || (isSuperuser && !isStaff)" class="nav-item">
                <router-link :to="{ name: 'sgn' }" class="nav-link collapsed">
                    <i class="fa-regular fa-paperclip"></i><span>SGN</span>
                </router-link>
            </li>
            <li v-if="isStaff || (isSuperuser && !isStaff)" class="nav-item">
                <router-link :to="{ name: 'admin-zoom' }" class="nav-link collapsed">
                    <i class="fa-regular fa-paperclip"></i><span>Zoom</span>
                </router-link>
            </li>
