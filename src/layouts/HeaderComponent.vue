  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="d-flex align-items-center justify-content-between">
      <a href="#" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">DevCode</span>
      </a>
...
<script setup>
import ClockComponentVue from '@/components/ClockComponent.vue';
...
const fetchUserProfile = async () => {
  ...
  if (accessToken) {
    try {
      ...
      userImage.value = response.data.image ? `${imgServerURL}${response.data.image.replace(/^\/+/, '')}` : `${imgServerURL}media/img/empty.png`;
    } catch (error) {
